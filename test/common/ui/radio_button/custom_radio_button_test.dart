...
void main() {
  testWidgets("CustomRadioGroupWidget should display radio buttons",
    ...
    expect(find.byType(typeOf<RoundRadioItem<_TestRadioValue>>()), findsNWidgets(radioModels.length));
